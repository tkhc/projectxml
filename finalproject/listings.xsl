...
,
               ...
               <tr>
                    <th>Est. Payment</th>
                    <td>
                         <xsl:value-of select="format-number(payment,'$#,##0')" />
                    </td>
                    <th>MLS #</th>
                    <td>
               ...
               <tr>
                    <td class="img" colspan="4">
                         <img src="{@rln}.jpg" alt="img" class="responsive"/>
                    </td>
               </tr>
               <tr>
 ...
 &#160;
                    ...
                    <td colspan="2">
                         ...
                         <xsl:for-each select="$agentsDoc">
                              ...
                              <br />
                              <img src="facebook-brands.svg" alt="icon" class="social-link"></img>
                              <img src="instagram-brands.svg" alt="icon" class="social-link"></img>
                              <img src="twitter-brands.svg" alt="icon" class="social-link"></img>
                         </xsl:for-each>
                    </td>
               </tr>
          </table>
